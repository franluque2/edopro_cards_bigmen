...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return bc:IsControler(1-tp) and s.CTFilter and Duel.IsExistingMatchingCard(s.cfilter,tp,LOCATION_MZONE,0,1,nil)
end
...
function s.CTFilter(c)
    return c:IsLevelBelow(8) or c:IsRankBelow(8) or c:IsLinkBelow(4)
end
