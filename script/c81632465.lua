...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return bc:IsControler(1-tp) and (bc:IsLevelBelow(8) or bc:IsRankBelow(8) or bc:IsLinkBelow(4)) and Duel.IsExistingMatchingCard(s.cfilter,tp,LOCATION_MZONE,0,1,nil)
end
