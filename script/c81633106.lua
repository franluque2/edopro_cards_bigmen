--The Mutsuba's Demolition Conscription
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local Meltdown=Duel.GetMatchingGroup(Card.IsCode, tp, LOCATION_EXTRA, 0, nil, 160015040)
    if #Meltdown>0 then
	local tc=Meltdown:GetFirst()
		while tc do
	
            Fusion.AddProcMix(tc,true,true,160208040,160208041)
