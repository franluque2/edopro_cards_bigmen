--Hormone GunMcQueen, the Magnificent Shichirin (CT)
local s,id=GetID()
...
function s.desfilter(c)
    return c:IsFaceup() and (c:IsLevelBelow(9) or c:IsRankBelow(9) or c:IsLinkBelow (4)) and (not c:IsAttribute(ATTRIBUTE_FIRE))
end
