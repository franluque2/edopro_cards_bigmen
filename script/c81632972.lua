...
local ARCHETYPE=0xc9

--All "Cosmos", "Ferocious Flora", "Fire Lily", "Battlecruiser Dianthus" and "CXyz Battleship Cherry Blossom" in your possession are also treated as "Aroma" monsters.
function s.archetypefilter(c)
  return c:IsCode(100000546, 511000055, 100000547, 40424929, 76419637)
end
