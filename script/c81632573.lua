...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetLP(tp)<=2000 and Duel.GetLP(1-tp)<=2000
end
...
function s.econ(e)
	return Duel.IsExistingMatchingCard(aux.FilterFaceup, e:GetHandlerPlayer(), LOCATION_ONFIELD, 0, 1, nil, Card.IsCode, 511000644)
end