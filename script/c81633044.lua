...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==0 then
        ...
        e8:SetTarget(function (_,c) return c:IsCode(99726621) end)
        ...
        e9:SetTarget(function (_,c) return c:IsCode(10019086) end)
...
function s.discon2(e,tp,eg,ep,ev,re,r,rp)
	...
	return re:IsActiveType(TYPE_MONSTER) and loc==LOCATION_MZONE and (code==10019086)
end
