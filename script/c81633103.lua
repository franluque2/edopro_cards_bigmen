--Conscription of the Rebooted Dragon
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local RedBoot=Duel.GetMatchingGroup(Card.IsCode, tp, LOCATION_EXTRA, 0, nil, 160015037)
    if #RedBoot>0 then
	local tc=RedBoot:GetFirst()
		while tc do
	
            Fusion.AddProcMix(tc,true,true,160315001,160015005)
