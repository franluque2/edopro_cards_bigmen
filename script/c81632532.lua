--Prophecy Flail of the Colors of the Wind, Butterflies, and Flowers (CT)
--華蝶風彩のプロフェシーフレイル
...
function s.desfilter(c)
	return c:IsFaceup() and (c:IsLevelBelow(8) or c:IsRankBelow(8) or c:IsLinkBelow(4)) and not c:IsMaximumModeSide()
end
