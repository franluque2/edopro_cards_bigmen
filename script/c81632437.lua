...
function s.desfilter(c)
	return c:IsType(TYPE_EFFECT) and (c:IsLevelBelow(8) or c:IsRankBelow(8) or c:IsLinkBelow(4)) and c:IsFaceup() and c:IsNotMaximumModeSide()
end
