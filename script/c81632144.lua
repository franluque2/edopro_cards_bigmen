...
--quick effect, reveal 1 level 5 or higher reptile in hand, tribute summon it using this card
	...
	--when send to grave from field increase attack of all reptiles you have by 500
...
function s.nscon(e,tp,eg,ep,ev,re,r,rp)
	...
	return (ph==PHASE_MAIN1 or ph==PHASE_MAIN2) and not (c:IsHasEffect(EFFECT_UNRELEASABLE_SUM))
end
...
function s.costfilter(c)
	return c:IsRace(RACE_REPTILE) and c:IsSummonable(true,nil,1) and c:IsLevelAbove(5) and not c:IsPublic()
end
