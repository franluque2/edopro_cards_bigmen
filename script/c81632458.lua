--Warning Scale Phosphorescence (CT)
-- 警告鱗光
...
function s.filter1(c,tp)
	return c:IsSummonPlayer(1-tp) and (c:IsLevelAbove(7) or c:IsRankAbove(7) or c:IsLinkAbove(3)) and c:IsFaceup() and c:IsLocation(LOCATION_MZONE)
end
function s.filter(c)
