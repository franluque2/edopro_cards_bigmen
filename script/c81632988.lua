--Conscription of the Eldest Arclight
...
local ARCHETYPE=0x127

--Monsters become Infinitracks
function s.archetypefilter(c)
  return c:IsCode(01586457, 38173725, 33911264, 97526666, 01992816, 32559361)
end
--Argent Chaos Force
function s.archetypefilter2(c)
    return c:IsCode(94220427)
  end
...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==0 then
        ...
        --Argent Chaos Force becomes Outrigger Expansion
        ...
        --Marshalling Field, Space Gate and Monopole Chain become Spin Turn
