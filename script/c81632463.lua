...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return a and a:IsControler(1-tp) and (a:IsLevelBelow(9) or a:IsRankBelow(9) or a:IsLinkBelow(4)) and tc and tc:IsDefensePos() and tc:IsControler(tp)
end
