...
local ARCHETYPE=0x24

local ARCHETYPE2=0x43

--add the conditions for the archetype swap here
function s.ScrapDragon(c)
  return c:IsCode(76774528)
end

function s.ScrapIron(c)
   return c:IsCode(511001641, 48497555, 85520170, 98427577, 511003083, 50947142, 511003049)
end
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local g=Duel.GetMatchingGroup(s.ScrapDragon, tp, LOCATION_ALL, LOCATION_ALL, nil)
    ...
    g=Duel.GetMatchingGroup(s.ScrapIron, tp, LOCATION_ALL, LOCATION_ALL, nil)
    ...
    g=Duel.GetMatchingGroup(s.Junk, tp, LOCATION_ALL, LOCATION_ALL, nil)
