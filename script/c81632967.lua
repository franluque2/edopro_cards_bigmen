...
local ARCHETYPE=0x187

--All EARTH Cyberse monsters in your possession are treated as "G Golem" monsters.
function s.archetypefilter(c)
  return c:IsType(TYPE_MONSTER) and c:IsAttribute(ATTRIBUTE_EARTH) and c:IsRace(RACE_CYBERSE)
end
